...
import cleancode.studycafe.asis.discount.StudyCafePricingService;
...
public class OutputHandler {
    ...
    public void askLockerPass(StudyCafeLockerPass lockerPass) {
        System.out.println();
        showAskMessage(lockerPass);
    }

    public void showPassOrderSummary(StudyCafePass selectedPass, StudyCafeLockerPass lockerPass) {
        showOrderInfo(selectedPass, lockerPass);
        showDiscountPrice(selectedPass);
    ...
    private static void showPassList(List<StudyCafePass> passes) {
    ...
    private static void showAskMessage(StudyCafeLockerPass lockerPass) {
    ...
    private static void showOrderInfo(StudyCafePass selectedPass, StudyCafeLockerPass lockerPass) {
        System.out.println();
    ...
    private static void showDiscountPrice(StudyCafePass selectedPass) {
        int discountPrice = StudyCafePricingService.getDiscountPriceFromPass(selectedPass);
        if (discountPrice > 0) {
    ...
    private static void showTotalPrice(StudyCafePass selectedPass, StudyCafeLockerPass lockerPass) {
        int totalPrice = StudyCafePricingService.getTotalPrice(selectedPass, lockerPass);
